...
//! Private ordered Cache Layer lookup, promotion, storage, and work accounting.
...
use super::{
    ...
    pack_file::{AccessStamp, PackFileGuardDto},
...
pub(super) struct CacheRestore {
    ...
    pub(crate) restore: PersistentRestore,
}
